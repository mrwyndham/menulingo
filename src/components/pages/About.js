    ...
    <div className="About">
      ...
      <div className="About--Contact">
        <div className="Contact--Container">
          <div className="Contact--Email About--Contact__Margin">
            <a href="mailto:info@biz365.com">
              <i className="material-icons">email</i>
            </a>
            <a href="mailto:info@biz365.com">
              <div>test@pysco.com.br</div>
            </a>
          </div>
          <div className="Contact--Phone About--Contact__Margin">
        ...
        <div className="Contact--Socials About--Contact__Margin">
          <div className="Socials Socials--Twitter">
            <svg
              width="100%"
              role="img"
              viewBox="0 0 24 24"
