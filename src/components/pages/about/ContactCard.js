...
const ContactCard = props => {
  ...
  const handleSocialIcons = (obj, icons) => {
    const newObj = [...obj];
    for (const social of obj) {
      for (const icon of icons) {
        if (social.name.toLowerCase() === icon.name.toLowerCase()) {
  ...
  const renderedSocials = handleSocialIcons(socials, socialNetworks).map(
    (social, index) => (
